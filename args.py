...
# Datasets
parser.add_argument('-train', '--trainroot', default='data/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='data/val.txt', type=str)
...
parser.add_argument('--num-classes', default=47, type=int, metavar='N',
...
parser.add_argument('--alpha', default=1, type=float, metavar='M',
                         help='alpha for ')
parser.add_argument('--beta', default=1.0, type=float, metavar='M',
